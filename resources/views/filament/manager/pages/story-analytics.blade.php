<x-filament-panels::page>
    ...
    <div class="space-y-6">
        ...
        @if ($stories->isEmpty())
            <x-filament::section>
                <p class="text-sm text-center text-gray-400 dark:text-gray-500 py-8">
                    ...
                    <div class="space-y-3">
                        @foreach ($progression as $prog)
                            <div class="rounded-lg border border-gray-200 dark:border-white/10 overflow-hidden">
                                <div class="px-4 py-2 bg-gray-50 dark:bg-white/5 border-b border-gray-100 dark:border-white/10">
